package com.myerstechnologies.extractor.VideoExtractionAPI.extractor.mystream;
...
public abstract class MyStreamExtractor {
    ...
    public MyStreamExtractor(Activity context) {
